...
<x-admin.feature-header
    ...
    description="Kelola penerbitan, status, pencabutan, pencarian, dan ekspor sertifikat siswa."
>
    <x-slot:actions>
...
<div class="admin-metric-grid">
    ...
    <x-admin.metric-card label="Siap Diterbitkan" :value="number_format($stats['eligible'])" hint="Siswa sudah memenuhi syarat" tone="yellow" />
...
<section class="admin-section-card">
    <x-admin.section-header
        ...
        description="Cari berdasarkan siswa, orang tua, course, nomor sertifikat, status, dan tanggal terbit."
    >
        <x-slot:actions>
    ...
    <form class="admin-filter-panel" method="GET" action="{{ route('admin.certificates.index') }}">
        <div class="admin-filter-grid certificate-filter-grid">
            <label class="admin-filter-field">
                ...
                <input type="search" name="q" value="{{ request('q') }}" placeholder="Nomor, siswa, orang tua, atau course">
            </label>
        ...
        <table class="admin-table admin-data-table certificate-table">
            ...
            @forelse($certificates as $certificate)
                <tr>
                    ...
                    <td>
                        <strong>{{ $certificate->learningPath?->title ?? 'Course tidak tersedia' }}</strong>
                ...
                <tr>
                    <td colspan="7">
                        <div class="admin-empty-state">
                            ...
                            <span>Terbitkan sertifikat untuk siswa yang sudah memenuhi syarat.</span>
                        </div>
                    </td>
                </tr>
            @endforelse
