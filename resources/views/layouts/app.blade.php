...
<footer class="site-footer">
    <div class="container footer-grid">
        <div><div class="brand footer-brand"><span class="brand-mark">S</span><span>SKILLPATH</span></div><p>Marketplace kelas nonakademik offline untuk anak usia 5–14 tahun dengan pengajar terverifikasi, jadwal tatap muka, dan pemantauan progres.</p></div>
        <div><strong>Belajar</strong><a href="{{ route('explore.index') }}">Semua Kelas</a><a href="{{ route('categories.index') }}">Kategori</a><a href="{{ route('instructors.index') }}">Pengajar</a></div>
    ...
    <div class="container footer-bottom"><small>© {{ date('Y') }} SKILLPATH. Marketplace kelas nonakademik offline anak.</small></div>
</footer>
