...
<div class="rating-line big"><strong>{{ number_format($averageRating,1) }}</strong><span>★</span><small>Mentor</small><small>Platform {{ number_format($platformRating,1) }} ★</small><small>{{ $reviewCount }} ulasan</small><small>{{ $studentCount }} peserta</small><small>Usia {{ $learningPath->min_age }}–{{ $learningPath->max_age }}</small></div>
