...
<section class="section compact">
    <div class="timeline">
        <article><span>01</span><div class="timeline-icon"><x-icon name="users" /></div><div><h2>Orang tua membuat akun</h2><p>Akun utama digunakan untuk transaksi, booking, kredit, review, dan monitoring perkembangan.</p></div></article>
        ...
        <article><span>05</span><div class="timeline-icon"><x-icon name="credit" /></div><div><h2>Sesi dapat dikonversi menjadi kredit</h2><p>Jika memenuhi kebijakan, sesi yang terlewat menjadi kredit untuk memilih sesi pengganti.</p></div></article>
