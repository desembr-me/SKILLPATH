...
{
    protected $fillable = ['category_id','instructor_id','title','slug','subtitle','description','age_min','age_max','level','price','sessions_count','duration_minutes','location_name','address','city','cover_emoji','accent','is_featured','status'];
