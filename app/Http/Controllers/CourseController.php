...
class CourseController extends Controller {
 ...
 public function show(Course $course){$course->load(['category','instructor','schedules']); $isWishlisted=auth()->check() && auth()->user()->wishlists()->where('course_id',$course->id)->exists(); return view('courses.show',compact('course','isWishlisted'));}
}
