...
class LiveClassController extends Controller
{
    public function index(Request $request){
        ...
        $sessions=LiveSession::whereIn('learning_path_id',$courseIds)->where('starts_at','>=',now()->subHours(2))->with(['learningPath','instructor.instructorProfile','bookings'])->orderBy('starts_at')->get();
