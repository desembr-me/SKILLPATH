...
class InstructorDashboardController extends Controller
{
    public function __invoke(Request $request){
        ...
        $upcoming=LiveSession::where('instructor_id',$request->user()->id)->where('starts_at','>=',now())->withCount('bookings')->with('learningPath')->orderBy('starts_at')->take(6)->get();
        ...
        return view('instructor.dashboard',compact('courses','upcoming','questions','studentCount','avgCompletion','revenue'));
    }
}
